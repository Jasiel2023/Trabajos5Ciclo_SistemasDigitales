...
const char* MQTT_USER     = "";    // Usuario creado en Mosquitto
...
void vTaskMQTT(void *pvParameters) {
    ...
    while (1) {
        ...
        if (xQueueReceive(xQueueMQTT, &msg, pdMS_TO_TICKS(100)) == pdTRUE) {
            ...
            float promedio = (humedad_m1 + humedad_m2 + humedad_m3) / 3.0;

            String textoAlerta = "Estado Normal";
            if (promedio < UMBRAL_ALERTA_HUMEDAD || humedad_m1 < 20 || humedad_m2 < 20 || humedad_m3 < 20) {
